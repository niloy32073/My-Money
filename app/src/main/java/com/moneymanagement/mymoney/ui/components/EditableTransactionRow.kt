...
fun EditableTransactionRow(transaction: Transaction,transactionScreenViewmodel: TransactionScreenViewmodel,wallet: Wallet?){
    Card(modifier = Modifier
        ...
        Row(modifier = Modifier.fillMaxWidth().padding(12.dp).clickable { transactionScreenViewmodel.openDialogBox(transaction,wallet) }, verticalAlignment = Alignment.CenterVertically, horizontalArrangement = Arrangement.SpaceBetween){
